...
module "private_keypair" {
  source                     = "git::https://github.com/sohanyadav/terraform-aws-keypair.git?ref=v1.0.0"
  name                       = "private-key"
  environment                = "test"
...
## Examples
For detailed examples on how to use this module, please refer to the [examples](https://github.com/sohanyadav/terraform-aws-keypair/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/sohanyadav/terraform-aws-keypair/blob/master/LICENSE) file for details.
...
| <a name="input_managedby"></a> [managedby](#input\_managedby) | ManagedBy, eg 'sohanyadav'. | `string` | `"sohanyadav"` | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/sohanyadav/terraform-aws-keypair?ref=v1.0.0"` | no |
